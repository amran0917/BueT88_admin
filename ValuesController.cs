...
namespace MyCrud.Controllers
{
    public class ValuesController : ApiController
    {
        ...
        [HttpGet]
        [Route("api/remember")]
        public IHttpActionResult Getremember()
        {

            var configs = new List<JObject>();
            var config1 = "{ Id: 1,Image:'https://localhost:44342/Resources/Images/client-1.jpg' , Name: 'Ahsanullah', MemberAddedOn: '04/10/2013', Department: 'CSE', Hall: 'Nazrul islam hall'}";
            var config2 = "{ Id: 2,Image:'https://localhost:44342/Resources/Images/client-2.jpg', Name: 'SehjanUllah', MemberAddedOn: '04/10/2014', Department: 'Architecture', Hall: 'Shere bangla hall'}";
            var config3 = "{ Id: 3,Image:'https://localhost:44342/Resources/Images/team-1.jpg', Name: 'SanaUllah', MemberAddedOn: '04/10/2019', Department: 'Civil', Hall: 'Titumir  hall'}";
            var config4 = "{ Id: 4,Image:'https://localhost:44342/Resources/Images/team-2.jpg', Name: 'SafiUllah', MemberAddedOn: '07/05/2020', Department: 'Mechanical', Hall: 'Shorowardi hall'}";
